...
An example discovered relationship is:
...
The predicted values are compared with the original E3SM outputs to quantify 
the accuracy of the discovered relationship.
